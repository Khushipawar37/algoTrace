    ...
    <section className="relative bg-smoky text-floral py-28 px-6 md:px-12 border-t border-olive/30">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
          ...
          <div className="lg:col-span-7 p-8 md:p-10 rounded-[28px] border border-olive/40 bg-[#171812] flex flex-col justify-between shadow-xl">
            <div>
              <div className="flex items-center justify-between border-b border-olive/20 pb-4 mb-6">
                ...
                <span className="font-mono text-xs text-olive">3 SESSIONS SAMPLED</span>
              </div>
              ...
              {/* Related problems */}
              <div className="mb-8">
                <span className="font-mono text-xs text-olive uppercase block mb-3">
                  AFFECTED RECENT ATTEMPTS:
                </span>
                <div className="flex flex-wrap gap-2 font-mono text-xs">
                  <span className="px-3 py-1.5 rounded-full border border-olive/30 bg-smoky text-bone">
          ...
          <div className="lg:col-span-5 p-8 md:p-10 rounded-[28px] border border-olive/40 bg-[#191A14] flex flex-col justify-between shadow-xl">
            <div>
              <div className="flex items-center justify-between border-b border-olive/20 pb-4 mb-6">
                <div className="flex items-center gap-2 font-mono text-xs text-bone font-semibold">
                ...
                <span className="font-mono text-xs text-olive">DP RECURSION</span>
              </div>
              ...
              <p className="text-sm font-sans text-bone/70 leading-relaxed mb-6">
            ...
            {/* Analytical Note */}
            <div className="p-5 rounded-btn border border-olive/30 bg-smoky/80 font-mono text-xs text-bone">
              <span className="text-olive block mb-1">ANALYTICAL DIAGNOSIS</span>
